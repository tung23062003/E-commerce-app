...
<head>
    ...
    <link rel="stylesheet" href="backend/dashboard/css/dashboard.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css" integrity="sha512-DTOQO9RWCH3ppGqcWaEA1BIZOC6xxalwEsw9c2QQeAIftl+Vegovlnee1c9QX4TctnWMn13TZye+giMm8e2LwA==" crossorigin="anonymous" referrerpolicy="no-referrer" />
</head>

<body>
    <div id="page" class="flex h-screen">
        <div id="side-bar" class="h-full w-[25%]">
            <div class="flex flex-col h-full p-3 bg-gray-900 text-gray-100">
                <div class="space-y-3">
                    <div class="flex items-center justify-between">
                        <h2>Dashboard</h2>
                        <button class="p-2">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                class="w-5 h-5 fill-current text-gray-100">
                    ...
                    <div class="relative">
                        ...
                        <input type="search" name="Search" placeholder="Search..."
                            class="w-full py-2 pl-10 text-sm border-transparent rounded-md focus:outline-none bg-gray-800 text-gray-100 focus:bg-gray-900">
                    </div>
                    <div class="flex-1">
                        <ul class="pt-2 pb-4 space-y-1 text-sm">
                            <li class="rounded-sm side-bar-item ">
        ...
        <div id="content" class="w-[75%]">
            <div id="nav-bar" class="flex justify-between items-center shadow-md h-[60px] p-3">
                <form action="" method="POST" class="nav-left relative w-[40%]">
                    <span class="absolute inset-y-0 left-0 flex items-center py-4">
                        <button type="submit" class="p-2 focus:outline-none focus:ring">
                            <svg fill="currentColor" viewBox="0 0 512 512" class="w-5 h-5 text-gray-400">
                    ...
                    <input type="search" name="Search" placeholder="Type to search..." class="w-full py-2 pl-10 text-sm border-transparent rounded-md focus:outline-none text-gray-900">
                </form>
                <div class="nav-right flex items-center gap-2">
                    <div class="notification w-10 h-10 rounded-[50%] overflow-hidden cursor-pointer flex justify-center items-center">
                        <i class="fa-regular fa-bell text-2xl"></i>
                    </div>
                    <div class="avatar-profile w-10 h-10 cursor-pointer relative">
                        <img src="https://vtv1.mediacdn.vn/zoom/640_400/562122370168008704/2023/6/14/photo1686714465501-16867144656101728954756.png" class="w-full h-full object-cover rounded-[50%]" alt="avatar">
                        <div class="sub-nav-profile w-[250px] absolute bg-white flex flex-col border-b border-stroke px-4 py-2 -translate-x-52 translate-y-5 rounded-md shadow-xl hidden z-50">
                            <div class="sn-profile-item flex items-center gap-3 py-2 px-4 rounded-xl hover:bg-slate-200 duration-300">
                                <i class="fa-regular fa-user text-l text-gray-900"></i>
                                <a href="#" class="text-l text-slate-500">My Profile</a>
                            </div>
                            <div class="sn-profile-item flex items-center gap-3 p-2 px-4 rounded-xl hover:bg-slate-200 duration-300">
                                <i class="fa-regular fa-address-book"></i>
                                <a href="#" class="text-l text-slate-500">My Contacts</a>
                            </div>
                            <div class="sn-profile-item flex items-center gap-3 p-2 px-4 rounded-xl hover:bg-slate-200 duration-300">
                                <i class="fa-solid fa-gear"></i>
                                <a href="#" class="text-l text-slate-500">Account Settings</a>
                            </div>
                            <div class="dropdown-divider mt-3 mb-2 border-b"></div>
                            <div class="sn-profile-item flex items-center gap-3 p-2 px-4 rounded-xl hover:bg-slate-200 duration-300">
                                <i class="fa-solid fa-right-from-bracket"></i>
                                <a href="#" class="text-l text-slate-500">Log Out</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="backend/dashboard/js/dashboard.js"></script>
</body>
